 ...
 * should have at most one of either its listViewComponentShouldDisplay or itemViewComponentShouldDisplay properties set to
 * true. If both are set to true then listViewComponentShouldDisplay will take priorty and itemViewComponentShouldDisplay
 * will be set to false in the redux state. Also displays prop should not have
 * any of listViewComponentShouldDisplay's child component properties (i.e. deleteModalComponentForListViewShouldDisplay &
 * listViewCreateItemSidbarComponentShouldDisplay) set to true if listViewComponentShouldDisplay property is not. Neither
 * should itemViewComponentShouldDisplay's child component property (i.e. deleteModalComponentForItemViewShouldDisplay) be set
 * to true if itemViewComponentShouldDisplay property is not. If this is the case for either of them,
 * then their child components will be set to false in the redux state. If any
 * expected properties in displays prop (e.g. listViewComponentShouldDisplay, itemViewComponentShouldDisplay, ect.) are
 ...
 * at most one of either its listViewComponentShouldDisplay or itemViewComponentShouldDisplay properties set to true. If
 * both are set to true then listViewComponentShouldDisplay will take priorty and itemViewComponentShouldDisplay will be set
 * to false in the redux state. Also displays prop should not have any of
 * listViewComponentShouldDisplay's child component properties (i.e. deleteModalComponentForListViewShouldDisplay &
 * listViewCreateItemSidbarComponentShouldDisplay) set to true if listViewComponentShouldDisplay property is not. Neither
 * should itemViewComponentShouldDisplay's child component property (i.e. deleteModalComponentForItemViewShouldDisplay) be set
 * to true if itemViewComponentShouldDisplay property is not. If this is the case for either of them,
 * then their child components will be set to false in the redux state. If any
